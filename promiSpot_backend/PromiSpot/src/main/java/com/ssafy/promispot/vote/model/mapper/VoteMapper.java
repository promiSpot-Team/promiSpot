...
public interface VoteMapper {
	...
	public int isVoted(int memberSeq, int promiseId, int placeId) throws SQLException;
	...
	public int removeVoter(int memberSeq, int promiseId, int placeId) throws SQLException;
